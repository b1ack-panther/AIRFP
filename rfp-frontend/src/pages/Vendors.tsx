...
import { Plus, Pencil, Trash2, X, Mail, Phone, MapPin, Building2 } from 'lucide-react';
...
const Vendors = () => {
  ...
  const handleDelete = (vendorId: string) => {
    // TODO: API call to delete vendor
    ...
    <div className="page-container animate-fade-in">
      ...
      <div className="flex gap-2 mb-6 overflow-x-auto pb-2">
        ...
        {categories.map(cat => (
          <button
            key={cat}
            className="px-3 py-1.5 text-sm font-medium rounded-full bg-secondary text-secondary-foreground hover:bg-secondary/80 whitespace-nowrap"
          >
